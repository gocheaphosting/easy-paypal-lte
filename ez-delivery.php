...
if (file_exists('pro/ez-update.php')) $updateText = "<p>If you bought it a while ago, and you would like to get an updated download link, please <a href='pro/ez-update.php'>visit our update portal.</a></p>" ;
else $updateText = "" ;
$pageHtml = "<p>Technical problems with the download.</p>
$updateText
<p>For other issues, please <a href='mailto:{$options['support_email']}'>contact me</a>.</p>" ;
if (!empty($_GET['dl'])) {
  $txn_id = $_GET['dl'] ;
